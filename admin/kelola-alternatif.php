    ...
    <div class="isi">
        ...
        <script>
            document.addEventListener("DOMContentLoaded", function() {
                ...
                // Cek total data
                if (rowCount > 15) {
                    // tentukan apa yang mau di non-aktifkan
                    tambahLink.removeAttribute('href');
                    tambahLink.style.pointerEvents = 'none'; // dibuat none agar tidak bisa di klik
                    tambahLink.style.color = 'grey'; // ganti warna link jadi abu-abu
        ...
        <a id="tambah-link" href="../admin/form-tambah-alternatif.php">/ Tambah Alternatif</a>
        ...
        <form method="post" action="perhitungan.php">
            ...
            <table id="data-table">
                ...
                <thead>
                    <tr>
                        <!-- <th type="hidden">Pilih <br> (semua) <br>
                        ...
                        <tr>
                            ...
                            <td>
                                <span class="action_btn1">
                                    <a href="../admin/form-edit-alternatif.php?id_alternatif=<?= $alternatif['id_alternatif']; ?>">Edit</a>
                                    <a href="../admin/hapus-alternatif.php?id_alternatif=<?= $alternatif['id_alternatif']; ?>">Hapus</a>
                                </span>
                            </td>
                        </tr>
