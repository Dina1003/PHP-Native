                    ...
                    <tr>
                        ...
                        <td>
                            <span class="action_btn1">
                                <a href="../user/detail_laporan.php?kode=<?= $hasil_akhir['kode']; ?>">Lihat</a>
                                <a href="../user/hapus_laporan.php?id_keputusan=<?= $hasil_akhir['id_keputusan']; ?>" >Hapus</a>
                                <a href="../user/cetak_laporan.php?kode=<?= $hasil_akhir['kode']; ?>" style="background: #da7e1c;">Cetak</a>
                            </span>
                        </td>
                    </tr>
